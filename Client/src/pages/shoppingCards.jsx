...
export const ShoppingCards = ({ onAdd }) => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    result = result.filter(
      (p) => p.price >= Number(minFilter) && p.price <= Number(maxFilter),
    );
          ...
          <div className="flex flex-row gap-15 items-start">
            ...
            <div className="flex flex-col sticky top-10 w-60 gap-5 self-start bg-neutral-600 p-5 rounded-xl">
              ...
              <div>
                ...
                <select
                  className="p-2 rounded-xl border-1 border-gray-100 text-gray-200"
              ...
              <div>
                ...
                <div className="flex justify-between gap-1">
                  <input
                    ...
                    min={0}
                    value={minFilter}
                    onChange={(e) => handleMinPriceFilterChange(e)}
                    className="w-full min-w-0 border-1 border-gray-100 rounded text-gray-200 font-bold pl-1"
                  ></input>
                  <p>-</p>
                  <input
                    type="number"
                    ...
                    max={9999}
                    value={maxFilter}
                    onChange={(e) => handleMaxPriceFilterChange(e)}
                    className="w-full min-w-0 border-1 border-gray-100 rounded text-gray-200 font-bold pl-1"
                  ></input>
                </div>
              </div>
              {/*categories*/}
              <div className="">
                <h2 className="text-gray-100 font-bold text-2xl mb-3">
                  Categories:
                </h2>
                <div className="flex flex-col gap-4">
                  {navCategories.map((c) => {
                    ...
                    return (
                      <label
                        key={c.value}
                        className="flex items-center group cursor-pointer justify-between"
                      >
                        <div className="flex items-center">
                          ...
                          <p
                            className={`transition-all duration-200 text-xl
                                                                ${
                                                                  isActive
                                                                    ? "text-gray-100 font-bold translate-x-2"
            ...
            <div className="flex flex-col flex-1 mr-20">
              <div className="flex flex-col justify-center gap-3 overflow-hidden flex-shrink-0">
                ...
                {filteredProducts.map((product) => (
                  <div
                    className="flex items-center bg-neutral-600 rounded-xl"
                    key={product.id}
                  >
                    <img
                    ...
                    <div className="flex flex-col flex-1 ml-3">
                      <h1 className="text-gray-100 font-bold flex-1 text-lg">
                        {product.name}
                      </h1>
                    ...
                    <button
                      className="mr-5 bg-gray-100 px-2 rounded transition-all duration-200 hover:bg-red-500 cursor-pointer"
