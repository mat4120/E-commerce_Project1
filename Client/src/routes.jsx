        ...
        <Router>
            <Routes>
                ...
                <Route element={<MainLayout cart={cart} />} >
                    ...
                    <Route path="/checkout" element={<PrivRoute><CheckoutPage onClear={onClearCart} items={cart} onQuantityChange={handleOnQuantityChange} order={onOrder} onAdd={onAddToCart}/></PrivRoute>} />
